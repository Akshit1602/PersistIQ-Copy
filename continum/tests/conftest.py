...
def null_experiment(rng):
    ...
    return {"ctrl": ctrl, "treat": treat, "n": n,
            "true_rate_ctrl": 0.18, "true_rate_treat": 0.18}
...
def positive_experiment(rng):
    ...
    return {"ctrl": ctrl, "treat": treat, "n": n,
            "true_rate_ctrl": 0.18, "true_rate_treat": 0.20,
            "true_delta_pp": 2.0}
...
def negative_experiment(rng):
    ...
    return {"ctrl": ctrl, "treat": treat, "n": n,
            "true_rate_ctrl": 0.20, "true_rate_treat": 0.17}
...
def revenue_arrays(rng):
    ...
    return {"ctrl": ctrl, "treat": treat,
            "true_mean_ctrl": 4000.0, "true_mean_treat": 4200.0}
...
def cuped_arrays(rng):
    ...
    return {
        "post_ctrl": post_ctrl, "post_treat": post_treat,
        "pre_ctrl":  pre_ctrl,  "pre_treat":  pre_treat,
        "true_delta": 0.02,
    }
