    ...
    def validate_dataframe(self, df: Any) -> List[str]:
        ...
        for col in self.non_nullable_columns:
            if col in df.columns:
                ...
                if null_pct > 1:
                    violations.append(
                        f"[NULL_VIOLATION] {col}: {null_pct:.1f}% nulls (non-nullable)"
                    )
...
SCHEMA_VERSION_HISTORY = [
    SchemaVersion(subsystem="silver", version=1, released_at="2024-01-01", notes="Initial schema"),
    SchemaVersion(
        subsystem="silver",
        version=2,
    ...
    SchemaVersion(
        subsystem="gold", version=1, released_at="2024-01-01", notes="Initial gold layer"
    ),
    SchemaVersion(
        subsystem="gold",
        version=2,
...
__all__ = [
    ...
    "BronzeTableMap",
    "BronzeColumnMap",
    "BronzeIngestionContract",
    "SilverViewContract",
    "INGESTION_API_VERSION",
