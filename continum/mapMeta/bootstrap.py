...
from continum.mapMeta.contracts import IngestionMode

logger = logging.getLogger("continum.mapMeta.bootstrap")
...
def bootstrap_from_connection(
    ...
    **credentials,
    ...
    from continum.ContextGraph import ContinumState
