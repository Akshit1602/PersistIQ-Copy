...
interface Props {
  ...
  /** Field-keyed suggestions from the store data behind this initiative. */
    ...
    <div className="min-w-0">
      ...
      {suggestion ? (
        <SuggestedValueBadge
          ...
          value={value}
          formatValue={(v) => `${field.prefix ?? ''}${v}${field.suffix ? ` ${field.suffix}` : ''}`}
...
export function StoreOpportunitySizingStep({ inputs, onChange, suggestions = {} }: Props) {
      ...
      <div className="rounded-[8px] border border-border-muted/15 bg-surface-base/50 px-3 py-3">
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <FieldWithLabel
            ...
            suggestion={suggestions[METRIC_FIELDS[0].key]}
