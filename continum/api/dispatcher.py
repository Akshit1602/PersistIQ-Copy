...
def run_module(name: str = None, state=None, llm=None, db=None, **kwargs) -> Any:
    ...
    try:
        ...
        try:
            from continum.runtime.intelligence import get_bus, publish_next_steps
            bus = get_bus()
...
def _build_registry() -> None:
    ...
    try:
        from continum.modules.phase0.discovery import (
    ...
    try:
        from continum.modules.phase1.planning import (
    ...
    try:
        from continum.modules.phase2.monitoring import run_health_monitor, run_sequential_testing
        register_module(ModuleSpec(
    ...
    try:
        from continum.modules.phase3.analysis import (
    ...
    try:
        from continum.core.monitoring.monitors import SequentialTester
    ...
    try:
        from continum.modules.phase4.deploy import run_uplift_modeller, run_decision_engine
        register_module(ModuleSpec(
...
def _build_registry() -> None:
    ...
    # ── Forecasting modules ───────────────────────────────────────────────────
    try:
        from continum.core.causal.forecasting import (
    ...
    # ── ROI Synthesis ─────────────────────────────────────────────────────────
    try:
        from continum.core.analytics.roi_synthesis import run_roi_synthesis
...
def _build_registry() -> None:
    ...
    try:
        from continum.modules.phase3.causal_analysis import run_causal_analysis_full
        register_module(ModuleSpec(
    ...
    # ── Balance diagnostics ──────────────────────────────────────────────────
    try:
        from continum.core.causal.balance import run_balance_battery, plot_love_plot, print_balance_report
    ...
    try:
        from continum.core.causal.engine import detect_distribution_shift
    ...
    try:
        from continum.core.analytics.opportunity import (
    ...
    try:
        from continum.runtime.ask_engine import run_ask
        register_module(ModuleSpec(
            "ask_v2",
    ...
    try:
        from continum.core.intelligence.analytical_reasoning import adaptive_recommendations
    ...
    try:
        from continum.core.intelligence.analytical_reasoning import generate_open_questions
    ...
    try:
        from continum.core.intelligence.analytical_reasoning import generate_root_cause
        ...
        def _run_root_cause(state, llm=None, db=None,
            ...
            if not anomalies and db is not None:
                ...
                try:
                    from continum.modules.intelligence.synthesis import run_anomaly_synthesis
...
def _build_registry() -> None:
    ...
    # ── Re-register Phase 2 ────────────────────────────────────────────────────
    try:
        from continum.modules.phase2.monitoring import (
    ...
    # ── Re-register Phase 4 ────────────────────────────────────────────────────
    try:
        from continum.modules.phase4.deploy import (
    ...
    try:
        from continum.runtime.cognition import run_analytical_chain
