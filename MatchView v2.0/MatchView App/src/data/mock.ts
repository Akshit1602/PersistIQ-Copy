...
export function buildWelcomeMessage(
  ...
  return `Initiative Setup & Benchmarking setup is complete for "${name}" (digital MVP).${hypLine}${goalLine} Your brief is ready in this chat and under Reports. You can refine modules anytime in Analytics Lab.`
}
