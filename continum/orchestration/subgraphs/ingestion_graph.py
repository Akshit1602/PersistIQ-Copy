...
from continum.state import AgentState, SchemaMetadata, MetricDefinition
...
def catalog_experiments_node(state: AgentState) -> dict:
    ...
    metadata.cataloged_experiments = [
        {"experiment_id": "exp_checkout_redesign", "status": "RUNNING", "primary_metric": "conversion_rate"},
