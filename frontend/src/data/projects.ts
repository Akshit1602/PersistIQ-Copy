...
export const INITIAL_PROJECTS: Project[] = [
  ...
  {
    id: 'proj-store-concurrent-impact',
    name: 'Store Concurrent Impact',
    description: 'Panel-matched concurrent lift testing for staffing, format, assortment, and pricing initiatives across retail stores.',
    objective: 'Measure true incremental lift from store-level initiatives while controlling for regional demand shifts and shadow initiatives.',
    channel: 'store',
    dataSource: { type: 'internal' },
...
export const INITIAL_EXPERIMENT_PROJECT_IDS: Record<string, string> = {
  ...
  'Dedicated Cashier Staffing Rollout': 'proj-store-concurrent-impact',
}
...
export const INITIAL_THREAD_GROUPS_WITH_PROJECTS: ThreadGroup[] = [
  ...
  {
    projectId: 'proj-store-concurrent-impact',
    experiment: 'Dedicated Cashier Staffing Rollout',
    threads: [{ id: 't6', title: 'Panel match review', timestamp: '4 days ago' }],
  },
]
