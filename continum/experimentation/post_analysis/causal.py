    ...
    **kwargs,
    ...
    if method in ("psm", "all"):
        try:
            ...
            from continum.experimentation.causal.balance import plot_love_plot, print_balance_report
        ...
        for m_key, m_result in results.items():
            if isinstance(m_result, dict) and not m_result.get("error"):
                ...
                bus.emit(
                    ...
                    insight_type=__import__("continum.insights.insight_bus",
                                           fromlist=["InsightType"]).InsightType.CAUSAL,
                    severity=__import__("continum.insights.insight_bus",
