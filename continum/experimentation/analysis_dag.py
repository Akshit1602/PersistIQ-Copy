...
try:
    from continum.experimentation.stats.srm_detector import detect_srm, detect_dimensional_srm
    from continum.experimentation.stats.bayesian import beta_binomial_test
    from continum.experimentation.stats.sequential import SequentialTester, compute_e_value
    _DEEP_STATS = True
except ImportError:
    _DEEP_STATS = False
...
def run_primary_analysis_task(
    ...
    import numpy as np
    from continum.experimentation.stats.statistics import proportion_test, means_test, check_srm
