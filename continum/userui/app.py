...
from continum.userui.routes import approval_router, chat_router, experiments_router
...
async def health_check():
    return {"status": "healthy", "app_name": settings.APP_NAME, "environment": settings.ENVIRONMENT}
